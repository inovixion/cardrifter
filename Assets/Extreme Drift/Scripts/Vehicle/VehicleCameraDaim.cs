...
public class VehicleCameraDaim : MonoBehaviour
{
    public static VehicleCameraDaim manage;
    ...
    {
        farCameraView = true;
        farCameraPosition = (AIControlDaim.manage.firstAINode.GetComponent<AINodeDaim>().nextNode
            .GetComponent<AINodeDaim>().nextNode
            .GetComponent<AINodeDaim>().nextNode
            .GetComponent<AINodeDaim>().nextNode
            .GetComponent<AINodeDaim>().nextNode
            .GetComponent<AINodeDaim>().nextNode.position)
    ...
    void LateUpdate()
    {
        ...
        if (Switch == -1)
        {
            ...
            GetComponent<Camera>().fieldOfView = Mathf.Clamp(AIControlDaim.CurrentVehicle.speed / 10.0f + 60.0f, 60, 90.0f);
        ...
        else if (Switch < AIControlDaim.CurrentVehicle.cameraView.cameraSwitchView.Count)
        {
            ...
            { 
                farCameraPosition = (AIControlDaim.CurrentVehicle.AIVehicle.nextNode
                    .GetComponent<AINodeDaim>().nextNode
                    .GetComponent<AINodeDaim>().nextNode
                    .GetComponent<AINodeDaim>().nextNode
                    .GetComponent<AINodeDaim>().nextNode
    ...
    {
        Switch++;
        if (Switch > AIControlDaim.CurrentVehicle.cameraView.cameraSwitchView.Count) { Switch = -1; }
    }
